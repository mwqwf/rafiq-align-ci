...
📌 **لماذا حفصٌ وحدَه؟ جوابٌ مقيسٌ لا اجتهاد (‏D-437):** وُسم هذا الملفُّ في تدقيق السطح
(‏D-428) بـ🚨 «نصٌّ ضيّق» لأنّه يقرأ `load_text("hafs")` فقط. والقياسُ على المصحف كلِّه في
الرواياتِ الستِّ (`locator_riwaya_invariance.py`) أظهر أنّ **طبقةَ التصويت لا تتغيّر بالرواية
البتّة**: المرشَّحاتُ 227 نفسُها، ورتبةُ كلِّ موضعٍ نفسُها، والمرشَّحون الثلاثةُ الأوائلُ أنفسُهم —
صفرُ فرقٍ في الخمس. ⇒ توسيعُ هذه البصمةِ إلى ستٍّ يشتري **ستَّ نسخٍ من البصمةِ نفسِها**
لا حراسةً جديدةً للبند 3. والضابطُ السالبُ هناك يصرخ بـ14 آيةً مزروعة ⇒ الأخضرُ يرى.
⛔ فلا تُوسَّع هذه القائمةُ إلى رواياتٍ أخرى إلا إن تغيّر التصويتُ أوّلاً — يُعاد القياسُ أوّلاً.
