...
# ✅ **وأُجيب بالقياس (‏14:1xZ · مناوبةُ المحرك):** نعم تشتعل — **ستُّ تشغيلاتٍ متتاليةٍ بحدث
#    `push` (11:10→11:26) أخضرُ كلُّها**، ودفعتان أُخريان اليومَ (13:27 · 13:29). وتبيّن أنّ
#    الضعفَ في **الجدولة** لا في الزناد: `keepalive` بالزناد نفسِه يشتعل نحوَ واحدةٍ من خمس،
#    ونبضةُ `:17` ثمّ `:43` صفرٌ في أربع فرص. التفصيلُ في `ops/out/BLOCKED.md`.
# ⇒ **فالمسبارُ مُغلَقٌ، وسطرُه يبقى في النسختين معاً** كي تصمت مرآةُ المقارنة: **حارسٌ إنذارُه
#    دائمٌ يُدرَّب الناسُ على تجاهله.**
